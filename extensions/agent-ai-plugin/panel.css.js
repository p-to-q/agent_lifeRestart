...
.ap-root{position:fixed;top:0;left:0;height:100vh;width:430px;max-width:92vw;z-index:100000;color:var(--ap-text);border-right:1px solid var(--ap-border);display:flex;flex-direction:column;transition:transform .25s ease,opacity .18s ease,visibility .18s ease;box-shadow:10px 0 28px rgba(0,0,0,.58),1px 0 18px rgba(48,208,208,.22);overflow:hidden;background:var(--ap-void);background-image:linear-gradient(180deg,rgba(0,16,32,.98),rgba(16,48,64,.98)),linear-gradient(rgba(48,208,208,.052) 1px,transparent 1px),linear-gradient(90deg,rgba(48,208,208,.045) 1px,transparent 1px);background-size:auto,28px 28px,28px 28px;opacity:1;visibility:visible;pointer-events:auto}
...
.ap-collapsed{transform:translateX(calc(-100% - 40px));opacity:0;visibility:hidden;pointer-events:none}
