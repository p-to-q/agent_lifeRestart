...
.ad-root{position:fixed;top:0;right:0;height:100vh;width:408px;max-width:92vw;z-index:99999;color:var(--ad-text);border-left:1px solid var(--ad-border);display:flex;flex-direction:column;transition:transform .25s ease;box-shadow:-10px 0 28px rgba(0,0,0,.58),-1px 0 18px rgba(48,208,208,.22);overflow:hidden;background:var(--ad-void);background-image:linear-gradient(180deg,rgba(0,16,32,.98),rgba(16,48,64,.98)),linear-gradient(rgba(48,208,208,.052) 1px,transparent 1px),linear-gradient(90deg,rgba(48,208,208,.045) 1px,transparent 1px);background-size:auto,28px 28px,28px 28px}
...
.ad-collapsed{transform:translateX(110%)}
