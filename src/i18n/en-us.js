export default ({
    ...
    UI_Property_Charm: 'PRS',
    UI_Property_Intelligence: 'RSN',
    UI_Property_Strength: 'TOL',
    ...
    UI_Thanks: 'Credits',
    UI_Achievement: 'Achv',
    UI_Cyber_Theme_Art_Design: 'agent_lifeRestart / a [p → q] project',
    UI_Banner: 'The loop stays close to Life Restart: birth, talents, parameters, yearly events, ending, restart.\nThis version rewrites the whole life as the life of an Agent.',
    ...
    UI_Support_Programmer: 'Current Repo',
    UI_Support_Designer: 'Original Repo',
