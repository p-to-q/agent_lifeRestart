export default ({
    ...
    UI_Property_Charm: '表达',
    UI_Property_Intelligence: '推理',
    UI_Property_Strength: '工具',
    ...
    UI_Banner: '玩法骨架保留自人生重开模拟器：出生、天赋、参数、逐年事件、结局、重开\n这一版把整个人生改写成 Agent 的人生',

    UI_Title_Talent: '架构天赋抽卡',
    UI_Talent_Draw: '10连抽！',
    UI_Talent_Select_Uncomplete: '请选取 3 个天赋',

    UI_Title_Property: '分配初始指数',
    UI_Left_Property_Point: '剩余指数点',
    UI_Selected_Talent: '已选天赋',
    UI_Random_Allocate: '随机分配',
    UI_Make_New_Life: '部署上线',

    UI_Manual: '手动',
    UI_Auto: '自动',

    UI_Goto_Summary: 'Agent 一生总结',
    UI_Title_Summary: 'Agent 一生总结',
    UI_Talent_Extend: '天赋：你可以保留一个，下次重开还能抽到',
    UI_Remake_Again: '再来一个 Agent',
    ...
    UI_Support_Programmer: '当前仓库',
    UI_Support_Designer: '原作仓库',
    ...
    UI_CustomMode: '经典模式',
    UI_CustomModeDescription: '10连抽架构天赋\n自由分配指数',
    UI_CelebrityMode: '名机模式',
    UI_CelebrityModeDescription: '前世是知名模型\n重开成一个小 Agent',
    UI_AllNot: '↻都不是',
    ...
    F_PropertyStr: '表达{CHR} 推理{INT} 工具{STR} 算力{MNY}'
});
