...
import { shouldEnableAgentObserver } from '../extensions/agent-observer/config.js';
import { installAgentObserver } from '../extensions/agent-observer/install.js';
import { shouldEnableAgentAiPlugin } from '../extensions/agent-ai-plugin/config.js';
import { installAgentAiPlugin } from '../extensions/agent-ai-plugin/install.js';
...
if (shouldEnableAgentObserver(query)) {
    installAgentObserver({ core });
}

if (shouldEnableAgentAiPlugin(query)) {
    installAgentAiPlugin();
}
