...
globalThis.goto = async tag => {
    let url;
    switch (tag) {
        case 'github': url = 'https://github.com/p-to-q/agent_lifeRestart'; break;
        case 'project': url = 'https://github.com/p-to-q/agent_lifeRestart'; break;
        case 'upstream': url = 'https://github.com/VickScarlet/lifeRestart'; break;
        case 'credits': url = 'https://github.com/p-to-q/agent_lifeRestart/blob/main/docs/CREDITS.md'; break;
        case 'ptoq': url = 'https://ptoq.io'; break;
    }
    if (!url) return;
    try {
